                        ...
                        <table border="0" width="100%" cellpadding="0" cellspacing="0">
                            <tr valign="top">
                                <td>
                                    ...
                                    <!-- start id-form -->
                                    <form action="" method="POST" id="add_category_form" style="margin-left: 30%;">
                                        <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                            <tr>
                                                <th valign="top">Category Name:</th>
                                                <td><input type="text"  id="category" name="category" style="width: 200px;" /><span class="err" id="category_err"></span></td>
