                                        ...
                                        <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                                            ...
                                            <?php for ($i = 0; $i < count($user_listing); $i++) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php if (isset($user_listing[$i]['is_admin']) && ($user_listing[$i]['is_admin'])) echo 'admin';
                                            else echo 'user' ?></td>
                                                    <td><a href=""><?php if (isset($user_listing[$i]['is_active']) && ($user_listing[$i]['is_active'])) echo 'active';
                                            else echo 'inactive' ?></a></td>
